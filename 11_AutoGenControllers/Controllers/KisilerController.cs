...
using _11_AutoGenControllers;

namespace _11_AutoGenControllers.Controllers
{
    public class KisilerController : Controller
    {
        private TestEntityFrameworkDbEntities db = new TestEntityFrameworkDbEntities();
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                db.Dispose();  //db nesnemi ramden sil ki verim artsin anlaminda.
            }
